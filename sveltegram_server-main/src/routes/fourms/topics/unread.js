...
const db = require('../HELP/database');
const user = require('../HELP/user');
...
const plugins = require('../HELP/plugins');
...
module.exports = function (Topics) {
	...
	Topics.pushUnreadCount = async function (uid) {
		...
		require('../HELP/socket.io').in(`uid_${uid}`).emit('event:unread.updateCount', {
