...
router.post ("/loginToProtectedSession", (req, res) => {
...
router.post ("/logoutFromProtectedSession", (req, res) => {
...
router.post ("/touchProtectedSession", (req, res) => {
