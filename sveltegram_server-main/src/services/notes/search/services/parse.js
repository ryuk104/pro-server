...
/**
 * @param {any[]} tokens
 * @param {{ highlightedTokens: any[]; fastSearch: any; }} searchContext
 */
function getFulltext(tokens, searchContext) {
    tokens = tokens.map((/** @type {{ token: any; }} */ t) => utils.removeDiacritic(t.token));
 ...
 * @param {{ originalQuery: string; addError: (arg0: string | undefined) => void; highlightedTokens: any[]; fuzzyAttributeSearch: any; }} searchContext
 */
