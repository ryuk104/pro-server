...
const user = require('../../routes/fourms/HELP/user');
const meta = require('../../routes/fourms/meta');
const plugins = require('../../routes/fourms/HELP/plugins');
const privileges = require('../../routes/fourms/HELP/privileges');
const utils = require('../utils');
const versions = require('../admin/versions');
const helpers = require('./helpers');

const controllers = {
	api: require('../../routes/fourms/controllers/api'),
	helpers: require('../../routes/fourms/controllers/helpers'),
};
